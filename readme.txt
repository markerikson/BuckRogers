...
Version 0.8.1 has a huge number of changes from 0.7.8 (and 0.8.0).  Here's some of the big ones (see changelog.txt for more details):

* Now requires the .NET Framework version 2.0 instead of .NET 1.1
* Replaced the old spreadsheet-like Combat Screen with a nice shiny new point-and-click one.
* Revamped the whole movement system.  Now, just point-and-click on the units you want to move, then click on where you want them to go.  As you move the mouse around, arrows show the shortest path from the starting point to where you're pointing at.
* Revamped the pre-game placement system, making it point-and-click as well.
